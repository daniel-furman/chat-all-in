...
def main(ep_number):
    ...
    excel_cleaned = pd.read_excel(
        f"data/all-in-transcripts/cleaned/{ep_number}_sections_full_cleaned.xlsx"
    )
    excel_cleaned.to_parquet(
        f"data/all-in-transcripts/cleaned/{ep_number}_sections_full_cleaned.parquet"
    )
    # print(excel_cleaned.head())
    data_files = {
        "E134": "data/all-in-transcripts/cleaned/E134_sections_full_cleaned.parquet",
        "E135": "data/all-in-transcripts/cleaned/E135_sections_full_cleaned.parquet",
    }
